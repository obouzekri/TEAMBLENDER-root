...
> DEPRECIE (2026-05-23): ce document est conserve pour contexte historique.
> Source de verite process actuelle: `docs/process/FEATURE_TO_PROD_FLOW.md` + regles associees (`MERGE_GATE_RULE.md`, `PR_PREVIEW_VALIDATION_RULE.md`, `PR_RAILWAY_LOGS_VALIDATION_RULE.md`, `PREVIEW_SMOKE_PASS_RULE.md`).
