...
> DEPRECIE (2026-05-23): documentation technique legacy archivee.
> Ne pas utiliser ce document comme reference d'implementation active pour le MVP.
> Pour les evolutions courantes, utiliser `frontend-next/` et la documentation process/config active sous `docs/`.
